  ...
  if (!dish) {
    return (
      <div className="container mx-auto px-4 py-20 text-center">
        <h2 className="font-heading text-2xl mb-4">Prato não encontrado</h2>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              <div>
                <h3 className="font-medium text-restaurant-brown mb-2 text-lg">Ingredientes</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <h3 className="font-medium text-restaurant-brown mb-2 text-lg">Preparação</h3>
                  <p className="text-gray-600">Time: {dish.prepTime || "30-45 minutes"}</p>
                </div>

                <div>
                  <h3 className="font-medium text-restaurant-brown mb-2 text-lg">Alérgenos</h3>
