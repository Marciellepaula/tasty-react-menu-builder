        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <div className="text-restaurant-brown">
              <span className="font-serif text-2xl font-bold">Savoria</span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#about" className="text-restaurant-brown hover:text-restaurant-gold transition-colors duration-300 font-medium">About</a>
            <a href="#menu" className="text-restaurant-brown hover:text-restaurant-gold transition-colors duration-300 font-medium">Menu</a>
            <a href="#contact" className="text-restaurant-brown hover:text-restaurant-gold transition-colors duration-300 font-medium">Contact</a>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="flex flex-col space-y-4 pt-2 pb-4 px-2">
              ...
              <a href="#about" className="text-restaurant-brown hover:text-restaurant-gold px-3 py-2 rounded-md font-medium" onClick={() => setIsOpen(false)}>About</a>
              ...
              <a href="#contact" className="text-restaurant-brown hover:text-restaurant-gold px-3 py-2 rounded-md font-medium" onClick={() => setIsOpen(false)}>Contact</a>
